...
import { get_user_by_mail, get_item_by_id, get_recommended_items, add_new_log } from '../databaseAPI';
...
const getSimilarProducts = (data, productId) => {
    ...
    data.forEach((product) => {
        if (!!product) {
            item_similarity = get_Jaccard_similarity(
                productId,
                product.id,
                idToProduct
            );
        ...
        return (
            <div className="wrapper">
                ...
                <div className="detailsDiv">
                    ...
                    {topFiveProducts && topFiveProducts.length > 0 &&(
                        ...
                        >
                                {topFiveProducts.map((subProduct, index) => (
                                    <div key={index} className="recommendedProductImage">
                                        <div>
                                            <a
                    ...
                    <div
                        className="recommendedProductImage"
                        style={{
                            display: "flex",
                            flexDirection: "row",
                            justifyContent: "space-between",
                    ...
                    >
                        <div className="similarProduct1">
                            <div className="similarProductImage1">
                                <a
                                    href={`http://localhost:3000/products/${similarProduct1?.id}`}
                                >
                                    <img
                                        src={similarProduct1?.image}
                                        alt={similarProduct1?.title}
                                        height="80px"
                                        width="80px"
                                        className="similarProductImage1"
                                    />
                                </a>
                            </div>
                            <div className="recommendedProductImage">
                                <p>
                                    <h6>{similarProduct1?.title}</h6>
                                </p>
                                <p>{similarProduct1?.price}</p>
                            </div>
                        </div>
                        <div className="similarProduct2">
                            <div className="recommendedProductImage">
                                <a
                                    href={`http://localhost:3000/products/${similarProduct2?.id}`}
                                >
                                    <img
                                        src={similarProduct2?.image}
                                        alt={similarProduct2?.title}
                                        height="80px"
                                        width="80px"
                                        className="recommendedProductImage"
                                    />
                            ...
                            <div className="recommendedProductImage">
                                <p>
                                    <h6>{similarProduct2?.title}</h6>
                                </p>
                                <p>{similarProduct2?.price}</p>
                            </div>
                        </div>
                        <div className="similarProduct3">
                            <div className="recommendedProductImage">
                                <a
                                    href={`http://localhost:3000/products/${similarProduct3?.id}`}
                                >
                                    <img
                                        src={similarProduct3?.image}
                                        alt={similarProduct3?.title}
                                        height="80px"
                                        width="80px"
                                        className="recommendedProductImage"
                                    />
                            ...
                            <div className="recommendedProductImage">
                                <p>
                                    <h6>{similarProduct3?.title}</h6>
                                </p>
                                <p>{similarProduct3?.price}</p>
                            </div>
                        </div>
                    </div>
                </div>
